...
========================================================
   ...
   Strategi: Liquidity Sweep + Order Block + Volume Spike
...
STATE_FILE          = "paper_trading.json"
TARGET_SYMBOL       = "ETH/USDT"
TARGET_PAIR_NAME    = "ETH-IDR"
FEE_TAX_RATE        = 0.0065  # Fee + Pajak PMK 68
...
class SMCIndependentTrader:
    ...
    def process_signal(self, signal_type, current_price, current_time):
        msg = None
        ...
        # 2. Cek Entry (Bull Sweep)
            ...
            if signal_type == "BULL_SWEEP":
                ...
                msg = (
                    ...
                    f"Target TP : Rp {current_price * 1.015:,.0f} (+1.5%)\n"
...
# --- MAIN EXECUTOR ---
async def main():
    print("DEBUG: Menjalankan Paper Trader SMC Mandiri (ETH-IDR)...")
    ...
    try:
        ...
        if pt_msg:
            ...
            print("  🧪 Notif Simulasi SMC ETH-IDR Terkirim")
        else:
            print("  — SMC ETH-IDR: Tidak ada aksi (Posisi aktif / Sinyal nihil)")
